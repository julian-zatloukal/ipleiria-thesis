...
\setcounter{chapter}{0} % Reset to start at A.
\renewcommand{\thechapter}{\Alph{chapter}} % Use letters A, B, C...
\renewcommand{\theHchapter}{annex.\Alph{chapter}} % Unique hyperref anchors for annexes
