...
\begin{titlepage}
    ...
    % Author.
    {\noindent\fontsize{14}{19}\selectfont\GetFirstAuthor}

    \ifdefined\GetSecondAuthor
        \vspace{8pt}
        {\noindent\fontsize{14}{19}\selectfont\GetSecondAuthor}
	\fi

    \ifdefined\GetThirdAuthor
        \vspace{8pt}
        {\noindent\fontsize{14}{19}\selectfont\GetThirdAuthor}
	\fi

    \ifdefined\GetFourthAuthor
        \vspace{8pt}
        {\noindent\fontsize{14}{19}\selectfont\GetFourthAuthor}
	\fi

    \ifdefined\GetFifthAuthor
        \vspace{8pt}
        {\noindent\fontsize{14}{19}\selectfont\GetFifthAuthor}
	\fi
