...
La primera condición de arranque de oscilación requiere que la fase de $S_{11}$ sea de \qty{0}{\degree} a la frecuencia de oscilación. De los resultados se obtiene que a \qty{1,132}{\GHz} la fase es de aproximadamente \qty{0,098}{\degree}, cumpliendo esta condición. La segunda condición establece que la magnitud de $S_{11}$ debe ser mayor que 1; en este caso, la ganancia del lazo es de 5.866 (en veces), verificando así la condición de arranque.
