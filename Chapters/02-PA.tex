...
\begin{itemize}
    \item \textbf{Fundamental (\qty{1}{\GHz}):} $P_{out} = \qty{11,61}{\dBm}$, correspondiente a una ganancia de \qty{11,61}{\dB} para una entrada de \qty{0}{\dBm}.
    \item \textbf{Segundo armónico (\qty{2}{\GHz}):} \qty{-36,28}{\dBm}, aproximadamente \qty{48}{\dB} por debajo del fundamental.
    \item \textbf{Tercer armónico (\qty{3}{\GHz}):} \qty{-56,58}{\dBm}, aproximadamente \qty{68}{\dB} por debajo del fundamental.
    \item \textbf{Armónicos superiores:} Por debajo de \qty{-70}{\dBm}, despreciables.
\end{itemize}
...
\begin{align}
P_1 &= 10^{11{,}61/10} = \qty{14,49}{\mW} \nonumber \\
P_2 &= 10^{-36{,}28/10} = \qty{2,36e-4}{\mW} \nonumber \\
P_3 &= 10^{-56{,}58/10} = \qty{2,20e-6}{\mW} \nonumber \\
P_4 &= 10^{-72{,}85/10} = \qty{5,19e-8}{\mW} \nonumber \\
P_5 &= 10^{-86{,}91/10} = \qty{2,04e-9}{\mW}
\end{align}
...
Este valor de THD es equivalente a aproximadamente \qty{-48}{\dB} respecto al fundamental, lo cual es aceptable para aplicaciones de radar donde la pureza espectral moderada es suficiente.
