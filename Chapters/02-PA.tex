...
En este apartado se analizan las formas de onda en el transitorio del amplificador y en el estado estacionario. Para el transitorio, en la Figura \ref{fig:pa_transient_waveforms} se pueden ver del lado izquierdo las formas de onda de tensión para colector, fuente y carga, y del lado derecho la forma de onda de corriente. Por otro lado, en la Figura \ref{fig:pa_steady_state_waveforms} se muestra de la misma manera las formas de onda luego del transitorio, en estado estacionario.
...
Durante el transitorio se observa cómo las señales evolucionan desde el estado inicial hasta alcanzar el régimen estacionario. La tensión de colector $V_C$ oscila entre \qty{0}{\V} y \qty{11,3}{\V} con una excursión máxima de aproximadamente \qty{11,3}{\V}. La corriente de colector $I_C$ varía entre \qty{-19,8}{\mA} y \qty{145,9}{\mA}, mostrando los picos característicos del arranque del amplificador. La tensión de fuente $V_{CC}$ se mantiene constante en \qty{8}{\V}, mientras que la tensión en la carga $V_{RL}$ presenta una oscilación de \qty{2,4}{\V} pico a pico.
...
En estado estacionario, las formas de onda presentan un comportamiento periódico estable. La tensión de colector $V_C$ oscila entre \qty{4,7}{\V} y \qty{11,3}{\V}, mostrando una excursión pico a pico de aproximadamente \qty{6,5}{\V} centrada alrededor de $V_{CC} = \qty{8}{\V}$. La corriente de colector $I_C$ varía entre \qty{-4,4}{\mA} y \qty{60,5}{\mA}, confirmando la operación en Clase AB donde el dispositivo conduce durante más de medio ciclo pero no de forma continua. La corriente en la carga $I_{RL}$ presenta una forma de onda sinusoidal simétrica con una amplitud de aproximadamente \qty{22}{\mA} pico, correspondiente a la potencia de salida esperada sobre la carga de \qty{50}{\ohm}.
